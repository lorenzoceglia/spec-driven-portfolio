# portfolio-data-layer Specification

## Purpose
Typed TypeScript data files in `src/data/` that hold all portfolio content, decoupled from components. Allows content to be updated without touching UI logic.
