# open-source-libraries Specification

## Purpose
Specifies filter tab behaviour and NPM link rendering for the open source section, covering the library/contribution taxonomy introduced when real project data was added.
