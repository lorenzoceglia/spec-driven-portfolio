# bubble-tooltip Specification

## Purpose
Tooltip component for the BubblePack visualization that shows a tech name when a bubble is clicked. Renders via React portal above all page elements, supports dismiss-on-outside-click, and clears automatically on filter tab change.
